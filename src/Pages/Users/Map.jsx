...
import {
  ...
  ImageOff, Heart, Shield, Droplets, Wind,
  Activity, Stethoscope, Ambulance, Baby,
} from "lucide-react";
...
const FACILITIES = [
  {
    ...
    latitude: 4.0511,
    longitude: 9.7679,
    hasPostLossCare: true,
    hasSurgical: true,
    hasBloodBank: true,
    hasMaternity: true,
    phone: "+237 233 42 09 22",
    address: "Rue Joss, Akwa",
    county: "Wouri",
    distanceKm: 1.4,
    rating: 4.2,
    reviews: 318,
    description: "The largest public hospital in Douala, offering comprehensive maternal and post-loss care with specialised gynaecology and obstetrics units. Features a fully equipped blood bank and 24/7 emergency services.",
    hours: "Open 24 hours",
    emergency: true,
    images: [
    ...
    amenities: ["Parking", "Pharmacy", "Laboratory", "ICU", "Blood Bank", "Radiology", "Maternity Ward", "Counselling"],
  },
  {
    id: 2,
    ...
    hasBloodBank: true,
    hasMaternity: true,
    phone: "+237 233 40 25 80",
    address: "Avenue Laquintinie, Bonabéri",
    county: "Wouri",
    distanceKm: 3.2,
    rating: 4.0,
    reviews: 204,
    description: "Regional hospital serving the Bonabéri area with strong maternity services and a dedicated post-loss counselling unit.",
    hours: "Open 24 hours",
    emergency: true,
    images: [
    ...
    amenities: ["Parking", "Pharmacy", "Counselling", "Maternity Ward", "Emergency", "Laboratory"],
  },
  {
    id: 3,
    name: "Clinique Bastos Douala",
    type: "Hospital",
    latitude: 4.0612,
    longitude: 9.7452,
    hasPostLossCare: true,
    ...
    rating: 4.5,
    reviews: 97,
    description: "Private clinic known for attentive care, modern equipment and compassionate post-loss support.",
    hours: "Mon–Sat 7 am–10 pm",
    emergency: false,
    images: [
      "https://images.unsplash.com/photo-1579154204601-01588f351e67?w=800&q=80",
    ],
    amenities: ["Wi-Fi", "Private Rooms", "Ultrasound", "Counselling", "Pharmacy", "Parking"],
  },
  {
    id: 4,
    name: "Centre Médical d'Akwa",
    type: "Health Centre",
    latitude: 4.0580,
    longitude: 9.7300,
    hasPostLossCare: false,
    hasSurgical: false,
    hasBloodBank: false,
    hasMaternity: true,
    ...
    rating: 3.8,
    reviews: 55,
    description: "Community health centre offering general consultations and antenatal care.",
    hours: "Mon–Fri 8 am–6 pm",
    emergency: false,
    images: [],
    amenities: ["Pharmacy", "Antenatal Care", "Vaccination"],
  },
  {
    id: 5,
    name: "Polyclinique Bonamoussadi",
    type: "Hospital",
    latitude: 4.0789,
    longitude: 9.7556,
    hasPostLossCare: true,
    ...
    rating: 4.3,
    reviews: 141,
    description: "Modern private hospital in the residential Bonamoussadi area with excellent post-loss and gynaecology services.",
    hours: "Open 24 hours",
    emergency: true,
    images: [
      "https://images.unsplash.com/photo-1516841273335-e39b37888115?w=800&q=80",
    ],
    amenities: ["Parking", "Pharmacy", "Surgery", "Maternity Ward", "ICU", "Counselling"],
  },
  {
    id: 6,
    name: "Centre de Santé Deido",
    type: "Health Centre",
    latitude: 4.0621,
    longitude: 9.7201,
    hasPostLossCare: false,
    ...
    rating: 3.6,
    reviews: 39,
    description: "Public health centre serving the Deido neighbourhood with basic maternity and child health services.",
    hours: "Mon–Sat 7:30 am–5:30 pm",
    emergency: false,
    images: [],
    amenities: ["Antenatal Care", "Vaccination", "Health Education"],
  },
  {
    id: 7,
    name: "Hôpital du District de Bonabéri",
    type: "Hospital",
    latitude: 4.0412,
    longitude: 9.6990,
    hasPostLossCare: true,
    ...
    hasBloodBank: true,
    hasMaternity: true,
    phone: "+237 233 41 33 90",
    address: "Bonabéri",
    county: "Wouri",
    distanceKm: 5.8,
    rating: 3.9,
    reviews: 176,
    description: "District hospital on the western bank with a blood bank and full surgical suite.",
    hours: "Open 24 hours",
    emergency: true,
    images: [
      "https://images.unsplash.com/photo-1551076805-e1869033e561?w=800&q=80",
    ],
    amenities: ["Parking", "Blood Bank", "Emergency", "Surgery", "Maternity Ward"],
  },
  {
    id: 8,
    name: "Polyclinique Santa Barbara",
    type: "Hospital",
    latitude: 4.0660,
    longitude: 9.7350,
    hasPostLossCare: true,
    ...
    hasBloodBank: false,
    hasMaternity: true,
    phone: "+237 699 123 987",
    address: "Bali, Douala",
    county: "Wouri",
    distanceKm: 2.8,
    rating: 4.4,
    reviews: 88,
    description: "Well-regarded private clinic in Bali with a compassionate team dedicated to maternal and post-pregnancy care.",
    hours: "Open 24 hours",
    emergency: true,
    images: [
      "https://images.unsplash.com/photo-1587351021759-3e566b6af7cc?w=800&q=80",
    ],
    amenities: ["Private Rooms", "Wi-Fi", "Pharmacy", "Surgery", "Maternity Ward", "Counselling"],
  },
  {
    id: 9,
    name: "Fatima Ngoh",
    ...
    rating: 4.8,
    reviews: 62,
    description: "Experienced nurse midwife providing home visits, grief support, and post-loss care coordination across Akwa and Deido.",
    hours: "Available Mon–Sat",
    emergency: false,
    images: [],
    amenities: ["Home Visits", "Grief Counselling", "Follow-up Care", "Referral Coordination"],
  },
  {
    id: 10,
    name: "Marie-Claire Bello",
    type: "Community Health Worker",
    specialty: "Community Midwife",
    coverageArea: "Bonamoussadi & New Bell",
    available: true,
    latitude: 4.0720,
    longitude: 9.7490,
    hasPostLossCare: true,
    ...
    hasBloodBank: false,
    hasMaternity: true,
    phone: "+237 698 890 123",
    address: "New Bell, Douala",
    county: "Wouri",
    distanceKm: 2.2,
    rating: 4.6,
    reviews: 48,
    description: "Community midwife specialising in emotional recovery and post-loss follow-up for women in New Bell and surroundings.",
    hours: "Available daily",
    emergency: false,
    images: [],
    amenities: ["Home Visits", "Emotional Support", "Referral Network", "Follow-up Calls"],
  },
];
    ...
    <div style={{ fontFamily: "'Manrope', system-ui, sans-serif" }}>
      ...
      <div style={{ position: "relative", height: 200, backgroundColor: "#f4f3f0", flexShrink: 0, overflow: "hidden" }}>
        {images.length > 0 ? (
          <>
            ...
            >
              <h2 style={{ color: "white", fontSize: 20, fontWeight: 700, margin: 0, textShadow: "0 1px 2px rgba(0,0,0,0.3)" }}>
                {facility.name}
              </h2>
          ...
          >
            ...
            <div
              style={{
                ...
                right: 0,
                padding: "16px 20px",
                background: "linear-gradient(to top, #f4f3f0, transparent)",
              }}
            >
        ...
        <div style={{ position: "absolute", top: 12, left: 12, display: "flex", gap: 6 }}>
          ...
          {isCHW && facility.available !== undefined && (
            <span
              style={{
                backgroundColor: facility.available ? "#16a34a" : "#6b7280",
                color: "white",
                padding: "4px 10px",
                borderRadius: 20,
                fontSize: 10,
      ...
      <div style={{ padding: "16px 20px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap", marginBottom: 16 }}>
          ...
          <span style={{ fontWeight: 700, fontSize: 14 }}>{facility.rating}</span>
          <span style={{ fontSize: 12, color: "#9ca3af" }}>({facility.reviews} reviews)</span>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 8, marginBottom: 16 }}>
            ...
            {facility.hasMaternity && (
              <span style={{ backgroundColor: "#fce7f3", color: "#9d174d", padding: "4px 12px", borderRadius: 20, fontSize: 11, fontWeight: 600 }}>
                <Baby size={12} style={{ display: "inline", marginRight: 4, verticalAlign: "middle" }} />
                Maternity Care
              </span>
            )}
          </div>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            ...
            <span style={{ fontWeight: 700 }}>{facility.distanceKm} km away</span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            <Car size={14} color="#9ca3af" />
            <span style={{ fontSize: 12 }}>{travel.car} by car</span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            <Clock size={14} color="#9ca3af" />
            <span style={{ fontSize: 12 }}>{travel.walk} walking</span>
          </div>
        </div>
        ...
        {facility.amenities && facility.amenities.length > 0 && (
          <div style={{ marginBottom: 16 }}>
            <p style={{ fontSize: 10, fontWeight: 600, color: "#bbb", textTransform: "uppercase", letterSpacing: "0.16em", marginBottom: 10 }}>
              Amenities
            </p>
        ...
        {isCHW && facility.coverageArea && (
          ...
          >
            <p style={{ fontSize: 10, fontWeight: 600, color: "#bbb", textTransform: "uppercase", letterSpacing: "0.16em", marginBottom: 4 }}>
              Coverage Area
            </p>
            <p style={{ fontSize: 14, fontWeight: 600, color: "#374151", margin: 0 }}>
              {facility.coverageArea}
            </p>
            {facility.specialty && (
              <>
                <p style={{ fontSize: 10, fontWeight: 600, color: "#bbb", textTransform: "uppercase", letterSpacing: "0.16em", margin: "8px 0 4px" }}>
                  Specialty
                </p>
        ...
        >
          ...
          <div>
            <p style={{ fontSize: 11, color: "#9ca3af", margin: 0 }}>Call for assistance</p>
            <p style={{ fontSize: 15, fontWeight: 700, margin: 0 }}>{facility.phone}</p>
          </div>
        </a>
        ...
        {isCHW ? (
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
              ...
              >
                {alertSent ? <Check size={16} /> : <Bell size={16} />}
        ...
        <div style={{ padding: "12px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <p style={{ fontSize: 11, color: "#9ca3af", margin: "2px 0 0" }}>
                {isCHW ? facility.specialty : facility.type} • {facility.distanceKm} km
              </p>
            </div>
            <button
              onClick={onClose}
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
              <Car size={10} color="#9ca3af" />
              <span style={{ fontSize: 11, color: "#6b7280" }}>{travel.car}</span>
            </div>
          </div>
          <button
          ...
          >
            View Full Details
            <ChevronRight size={12} style={{ marginLeft: 6, verticalAlign: "middle" }} />
          </button>
        </div>
      </div>
            ...
            >
              <div
                style={{
                  ...
                  height: 20,
                  borderRadius: 6,
                  backgroundColor: filters[option.key] ? "#16a34a" : "white",
                  border: `1.5px solid ${filters[option.key] ? "#16a34a" : "#d1d5db"}`,
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
              ...
              <div style={{ flex: 1 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  ...
                  <p style={{ fontSize: 13, fontWeight: 600, margin: 0 }}>{option.label}</p>
                </div>
              </div>
              <input
                type="checkbox"
...
function DraggableSheet({ facility, userLocation, onDirections, onClose }) {
  ...
  const handleDragMove = (clientY) => {
    ...
    newHeight = Math.max(snapPoints.collapsed, Math.min(snapPoints.full, newHeight));
    setHeight(newHeight);
  };
  ...
  const handleDragEnd = (clientY) => {
    ...
    const distances = {
      collapsed: Math.abs(finalHeight - snapPoints.collapsed),
      expanded: Math.abs(finalHeight - snapPoints.expanded),
      full: Math.abs(finalHeight - snapPoints.full),
    };
    
    let targetHeight = snapPoints.expanded;
    if (distances.collapsed < distances.expanded && distances.collapsed < distances.full) {
      targetHeight = snapPoints.collapsed;
    } else if (distances.full < distances.expanded && distances.full < distances.collapsed) {
  ...
  return (
    <div
      style={{
        ...
        zIndex: 1200,
        transition: isDragging ? "none" : "height 0.25s cubic-bezier(0.32, 1.15, 0.5, 1)",
        display: "flex",
        flexDirection: "column",
        touchAction: "none",
      }}
...
export default function MaternalHealthMap() {
  ...
  const visibleFacilities = useMemo(() => {
    ...
    if (filters.hospitalsOnly) {
      filtered = filtered.filter((f) => f.type === "Hospital");
    }
    if (filters.clinicsOnly) {
      filtered = filtered.filter((f) => f.type === "Clinic" || f.type === "Health Centre");
    }
    if (filters.chwOnly) {
      filtered = filtered.filter((f) => f.type === "Community Health Worker");
    }
    if (filters.postLossOnly) {
      filtered = filtered.filter((f) => f.hasPostLossCare);
    }
    if (filters.emergencyOnly) {
      filtered = filtered.filter((f) => f.emergency === true);
    }
  ...
  const activeFacilityId = previewFacility?.id ?? selectedFacility?.id ?? null;
    ...
    >
      ...
      >
        ...
        {visibleFacilities.map((facility) => (
          <Marker
            ...
            icon={getPinForFacility(facility, activeFacilityId)}
            eventHandlers={{
              click: (e) => {
                L.DomEvent.stopPropagation(e);
                if (mapRef.current) {
                  handleMarkerClick(facility, mapRef.current);
                }
              },
            }}
          />
      ...
      {locationDenied && (
        ...
        >
          ...
          <span style={{ fontSize: 12, fontWeight: 500, color: "#92400e" }}>
            Location access needed for accurate distances and directions
          </span>
        </div>
      )}
      ...
      <div
        style={{
          ...
          top: 16 + topOffset,
          left: 72,
          right: selectedFacility && isDesktop ? 432 : 80,
          maxWidth: 500,
          zIndex: 1000,
          display: "flex",
          gap: 8,
      ...
      >
        ...
        >
          ...
          <input
            ...
            placeholder="Search hospitals, clinics, or CHWs..."
            style={{
              flex: 1,
              border: "none",
              outline: "none",
      ...
      {previewFacility && !selectedFacility && (
        <MiniCard
          ...
          onViewDetails={() => {
            setSelectedFacility(previewFacility);
            setPreviewFacility(null);
          }}
      ...
      {/* Detail Panel - Desktop or Mobile */}
      {selectedFacility && isDesktop && (
        <SidePanel
          facility={selectedFacility}
          userLocation={userLocation}
          onDirections={() => handleDirections(selectedFacility)}
      ...
      {!selectedFacility && !previewFacility && (
        ...
        >
          <p style={{ fontSize: 9, fontWeight: 700, color: "#bbb", textTransform: "uppercase", letterSpacing: "0.16em", marginBottom: 8 }}>
            Facility Types
          </p>
          <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              <div style={{ width: 10, height: 10, borderRadius: "50%", backgroundColor: "#16a34a" }} />
              <span style={{ fontSize: 11, color: "#6b7280" }}>Hospital</span>
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              <div style={{ width: 10, height: 10, borderRadius: "50%", backgroundColor: "#6b7280" }} />
              <span style={{ fontSize: 11, color: "#6b7280" }}>Clinic / Health Centre</span>
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              <div style={{ width: 10, height: 10, borderRadius: "50%", backgroundColor: "#111111" }} />
              <span style={{ fontSize: 11, color: "#6b7280" }}>Community Health Worker</span>
            </div>
          </div>
        </div>
      )}
